...
public class OrderConfirmationPage extends StartDriver {
...
//    private WebDriver driver;
    ...
    @FindBy(css = "#center_column div.box a")
    @CacheLookup
    private WebElement expertCustomerSupportTeam;
    ...
    private final String pageLoadedText = "- Do not forget to insert your order reference DMKXHKQYI in the subject of your bank wire";

    private final String pageUrl = "/index.php?controller=order-confirmation&id_cart=749132&id_module=3&id_order=74601&key=76afb2170a71135061f2d4f0eea22a57";
    ...
    /**
     * Click on Expert Customer Support Team. Link.
     *
     * @return the OrderConfirmationPage class instance.
     */
    public OrderConfirmationPage clickExpertCustomerSupportTeamLink() {
        expertCustomerSupportTeam.click();
        return this;
    }
     ...
     * @return the OrderConfirmationPage class instance.
     */
    public OrderConfirmationPage clickJoeBlackLink() {
        joeBlack.click();
        return this;
    }
